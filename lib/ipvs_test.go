...
func TestGenerateGraphDefinition(t *testing.T) {
  ...
  a := graphdef["proc.net.ip_vs.*.active_conns"]
  assert.EqualValues(t, "integer", a.Unit)
  assert.Len(t, a.Metrics, 8)
  assert.EqualValues(t, "192.168.1.1:80", a.Metrics[0].Label)
  assert.EqualValues(t, "192_168_1_1_80", a.Metrics[0].Name)
  ...
  assert.EqualValues(t, "192.168.1.2:80", a.Metrics[1].Label)
  assert.EqualValues(t, "192_168_1_2_80", a.Metrics[1].Name)
  assert.EqualValues(t,            false, a.Metrics[1].Diff)
  assert.EqualValues(t,            false, a.Metrics[1].Stacked)
  assert.EqualValues(t,                0, a.Metrics[1].Scale)

  assert.EqualValues(t, "192.168.1.1:443", a.Metrics[2].Label)
  assert.EqualValues(t, "192_168_1_1_443", a.Metrics[2].Name)
  assert.EqualValues(t,             false, a.Metrics[2].Diff)
  assert.EqualValues(t,             false, a.Metrics[2].Stacked)
  assert.EqualValues(t,                 0, a.Metrics[2].Scale)

  assert.EqualValues(t, "192.168.1.2:443", a.Metrics[3].Label)
  assert.EqualValues(t, "192_168_1_2_443", a.Metrics[3].Name)
  assert.EqualValues(t,             false, a.Metrics[3].Diff)
  assert.EqualValues(t,             false, a.Metrics[3].Stacked)
  assert.EqualValues(t,                 0, a.Metrics[3].Scale)

  assert.EqualValues(t, "192.168.1.53:53", a.Metrics[4].Label)
  assert.EqualValues(t, "192_168_1_53_53", a.Metrics[4].Name)
  assert.EqualValues(t,             false, a.Metrics[4].Diff)
  assert.EqualValues(t,             false, a.Metrics[4].Stacked)
  assert.EqualValues(t,                 0, a.Metrics[4].Scale)

  assert.EqualValues(t, "192.168.2.53:53", a.Metrics[5].Label)
  assert.EqualValues(t, "192_168_2_53_53", a.Metrics[5].Name)
  assert.EqualValues(t,             false, a.Metrics[5].Diff)
  assert.EqualValues(t,             false, a.Metrics[5].Stacked)
  assert.EqualValues(t,                 0, a.Metrics[5].Scale)

  assert.EqualValues(t, "192.168.1.53:53", a.Metrics[6].Label)
  assert.EqualValues(t, "192_168_1_53_53", a.Metrics[6].Name)
  assert.EqualValues(t,             false, a.Metrics[6].Diff)
  assert.EqualValues(t,             false, a.Metrics[6].Stacked)
  assert.EqualValues(t,                 0, a.Metrics[6].Scale)

  assert.EqualValues(t, "192.168.2.53:53", a.Metrics[7].Label)
  assert.EqualValues(t, "192_168_2_53_53", a.Metrics[7].Name)
  assert.EqualValues(t,             false, a.Metrics[7].Diff)
  assert.EqualValues(t,             false, a.Metrics[7].Stacked)
  assert.EqualValues(t,                 0, a.Metrics[7].Scale)

  a = graphdef["proc.net.ip_vs.*.inactive_conns"]
  assert.EqualValues(t, "integer", a.Unit)
  assert.Len(t, a.Metrics, 8)
  assert.EqualValues(t, "192.168.1.1:80", a.Metrics[0].Label)
  assert.EqualValues(t, "192_168_1_1_80", a.Metrics[0].Name)
  ...
  a = graphdef["proc.net.ip_vs.*.weight"]
  assert.EqualValues(t, "integer", a.Unit)
  assert.Len(t, a.Metrics, 8)
  assert.EqualValues(t, "192.168.1.1:80", a.Metrics[0].Label)
  assert.EqualValues(t, "192_168_1_1_80", a.Metrics[0].Name)
